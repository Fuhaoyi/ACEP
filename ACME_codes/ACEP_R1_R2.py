...
y_pre_all = model_R12.predict([x_test_onehot, x_test_pssm]).flatten()
y_pre_1_29 = model_R12.predict([x_test_onehot1_29, x_test_pssm1_29]).flatten()
y_pre_30_200 = model_R12.predict([x_test_onehot30_200, x_test_pssm30_200]).flatten()
print('####################       R1+R2        ######################')
